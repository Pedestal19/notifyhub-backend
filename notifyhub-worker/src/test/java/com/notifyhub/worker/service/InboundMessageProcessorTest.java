...
public class InboundMessageProcessorTest {
    ...
    void processBatch_movesReceivedToProcessed() {
        InboundMessageRepository inboundMessageRepository = mock(InboundMessageRepository.class);
        InboundMessageProcessor inboundMessageProcessor = new InboundMessageProcessor(inboundMessageRepository);
